...
<div id="block1" class="px-4 py-5 my-5 text-center">
  ...
  <div class="col-lg-6 mx-auto">
    ...
    <p class="lead mb-4">In a way.. just create a new event with the same input as the deleted event. It will have a new unique identifier, however it won't be marked as deleted, and function like a normal event.</p>
